...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p1 = element("p");
    			t2 = text(/*name*/ ctx[1]);
    			add_location(p0, file, 41, 4, 795);
    			add_location(p1, file, 42, 4, 828);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "nameInput svelte-1nh5qa3");
    			attr_dev(input, "placeholder", placeholder);
    			add_location(input, file, 36, 2, 618);
    			attr_dev(button, "class", "generateBtn svelte-1nh5qa3");
    			add_location(button, file, 37, 2, 686);
    			attr_dev(div, "class", "wrapper svelte-1nh5qa3");
    			add_location(div, file, 35, 0, 593);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function handleGenerate() {
    		$$invalidate(1, name = `Abu ${inputName}`);
    	}
